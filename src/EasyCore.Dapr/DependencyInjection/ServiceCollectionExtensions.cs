...
public static class ServiceCollectionExtensions
{
    ...
    /// <summary>Registers Dapr using <see cref="IHostApplicationBuilder.Configuration"/>.</summary>
    public static IServiceCollection EasyCoreDapr(
        this IHostApplicationBuilder builder,
        Action<DaprOptions>? configure = null)
    {
        ArgumentNullException.ThrowIfNull(builder);
        return builder.Services.EasyCoreDapr(builder.Configuration, configure);
    }
    ...
    public static IServiceCollection EasyCoreDaprAll(this IServiceCollection services)
    {
        ArgumentNullException.ThrowIfNull(services);
        return services
            .EasyCoreDaprInvocation()
            .EasyCoreDaprState()
            .EasyCoreDaprPubSub()
            .EasyCoreDaprSecrets()
            .EasyCoreDaprBindings();
    }
        ...
        Action<EasyCoreDaprActorOptions>? configure = null)
    {
        ...
        if (actorOptions.Registrations.Count == 0)
        {
            throw new InvalidOperationException(
                "EasyCoreDaprActors requires at least one RegisterActor<T>().");
        }
        ...
        Action<EasyCoreDaprWorkflowOptions>? configure = null)
    {
        ...
        {
            throw new InvalidOperationException(
                "EasyCoreDaprWorkflow requires at least one RegisterWorkflow / RegisterActivity.");
        }
